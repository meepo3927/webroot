...
@font-face {font-family: 'laydate-icon';
  src: url('./laydatefonts/iconfont.eot');
  src: url('./laydatefonts/iconfont.eot#iefix') format('embedded-opentype'),
  url('./laydatefonts/iconfont.svg#iconfont') format('svg'),
  url('./laydatefonts/iconfont.woff') format('woff'),
  url('./laydatefonts/iconfont.ttf') format('truetype');
}
